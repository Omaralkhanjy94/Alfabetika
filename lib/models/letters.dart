...
class Letters {
  ...
  late final List<Letter> _bringLetters = _letters
      .map((e) => Letter(
            letterName: e,
          ))
      .toList();
  ...
  Future<void> playSound(String soundName) async {
    ...
    // Load the asset bytes and play them so bundled assets work correctly.
    final byteData = await rootBundle.load(audioasset);
    final soundBytes = byteData.buffer.asUint8List();
